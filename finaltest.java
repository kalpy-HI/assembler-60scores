...
public class finaltest{
    ...
    public static void main(String [] argv) throws IOException {
        ...
        FileWriter dataFile = new FileWriter("tttteeeessssttt.txt");
        ...
        //pass2 start
        // here is first line
        FileReader fr2 = new FileReader("Figure2.1.txt");
        ...
        for(;(line = br2.readLine())!= null;){
            ...
            if(many==3){
                if(token2.equals("BYTE")){
                    ...
                    String token3 = st1.nextToken();
                    input.write(whereline+"\t"+Integer.toHexString(location)+"\t"+line+"\t"+String.format("%06d",Integer.parseInt(token3))+"\r\n");
                    location += 3;
                }
            ...
            //2 tokens
                     ...
                     if(optab.containsKey(token1)){
                        ...
                        if(token2.charAt(token2.length()-2)==','){
                            int a = 32768 + symval.intValue();
                            input.write(whereline+"\t"+location+"\t"+line+"\t"+opcode+Integer.toHexString(a).toUpperCase()+"\r\n");
                        }
                        else input.write(whereline+"\t"+location+"\t"+line+"\t"+opcode+Integer.toHexString(symval).toUpperCase()+"\r\n");
                        location += 3;
                     }
            }
            whereline+=5;
